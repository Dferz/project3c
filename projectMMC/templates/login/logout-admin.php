<html>
<head>
	<title>Logout || Muhammadiyah Medical Centre</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="content" id="login">
		<form>
			<h1>Anda telah melakukan logout, Terima Kasih Admin!</h1>
			<a href="/projectMMC" class="btn btn-warning btn-lg btn-block" role="button">Kembali ke Halaman Depan</a>
		</form>
	</div>
	<div class="footer">
